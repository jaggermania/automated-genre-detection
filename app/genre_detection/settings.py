"""
Django settings for genre_detection project.
...
SECRET_KEY = '1)*wip40+ua6*w24f5abipc*loeyd9#77x53ej_itbz9(it1nd'
...
ROOT_URLCONF = 'genre_detection.urls'
...
WSGI_APPLICATION = 'genre_detection.wsgi.application'
